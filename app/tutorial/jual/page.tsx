...
const tutorial = {
  title: "Tutorial Jual Akun di DreamSTORE",
  description:
    "Ikuti langkah-langkah berikut untuk menjual akun game kamu melalui DreamSTORE dengan cara yang rapi dan aman untuk pembeli.",
  steps: [
    {
      text: "Buka bot @storeDREAM_bot di Telegram lalu pilih menu JUAL / SELL.",
      image: "/tutorial/jual/step-1.png",
    },
    {
      text: "Pilih game dan kategori akun yang sesuai dengan akun yang ingin kamu jual.",
      image: "/tutorial/jual/step-2.png",
    },
    {
      text: "Isi FORMAT DreamSTORE dengan lengkap: jenis login, progres akun, skin / item penting, dan catatan tambahan jika perlu.",
      image: "/tutorial/jual/step-3.png",
    },
    {
      text: "Tentukan harga jual yang wajar dan metode pembayaran yang kamu terima, lalu kirim FORMAT tersebut ke bot / admin.",
      image: "/tutorial/jual/step-4.png",
    },
    {
      text: "Tunggu proses verifikasi / posting dari admin, lalu respons dengan cepat jika ada pertanyaan dari calon pembeli.",
      image: "/tutorial/jual/step-5.png",
    },
    {
      text: "Setelah ada pembeli yang deal, ikuti instruksi admin untuk proses pengiriman data akun sampai transaksi dinyatakan selesai.",
      image: "/tutorial/jual/step-6.png",
    },
  ],
};

export default function TutorialJualPage() {
  return (
      ...
      <div className="mx-auto flex min-h-screen max-w-md flex-col gap-5 px-4 pb-8 pt-4">
        ...
        <section className="mt-auto space-y-3 rounded-2xl border border-yellow-500/25 bg-gradient-to-r from-[#151521] via-[#211b33] to-[#151521] p-4 shadow-[0_0_24px_rgba(234,179,8,0.2)]">
          <p className="text-[0.7rem] leading-relaxed text-muted-foreground">
            Catatan: Jangan pernah memberikan akses email / data lain di luar
            kesepakatan. Jika ada hal yang terasa janggal, segera hubungi admin
            DreamSTORE.
          </p>
          <Button
            asChild
